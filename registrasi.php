        ...
        <form class="center" role="form" method='post' action="registrasiproses.php">
            <fieldset class="registration-form">
                <div class="form-group">
                    <?php if (isset($_SESSION['errorreg'])){ echo $_SESSION['errorreg'];}?></br>
                    ...
                    <?php if (isset($_SESSION['username_ganda'])){ ?> <i class="icon-remove"></i><?php echo $_SESSION['username_ganda'];}
                     else if (isset($_SESSION['empty_username'])){ ?> <i class="icon-remove"></i><?php echo $_SESSION['empty_username'];} 
                     else if (isset($_SESSION['username_valid'])){ ?> <i class="icon-ok"></i> username <?php echo  $_SESSION['username_valid'];?> tersedia<?php } ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    ?>"
                    placeholder="Password" class="form-control"><div id="hasil"></div>
                <?php if (isset($_SESSION['empty_pass'])){ ?> <i class="icon-remove"></i><?php echo $_SESSION['empty_pass'];}
                else if (isset($_SESSION['pass_weak'])){ ?> <i class="icon-remove"></i>password lemah <?php }
                else if (isset($_SESSION['pass_medium'])){ ?> <i class="icon-remove"></i>password medium <?php }
                else if (isset($_SESSION['pass_strong'])){ ?> <i class="icon-remove"></i>password setrong <?php } ?>
                    </div>
                <div class="form-group">
                    <input type="password" id="password_confirm" name="password_confirm" onkeyup="validasi(event,2)" placeholder="Password (Confirm)" class="form-control"><div id="cocok"></div>
                    <?php if (isset($_SESSION['errorpass'])){ ?> <i class="icon-remove"></i><?php echo $_SESSION['errorpass'];}
                    else if (isset($_SESSION['fail_cocok'])){ ?> <i class="icon-remove"></i><?php echo $_SESSION['fail_cocok'];}?>
                </div> 
                <div class="form-group">
