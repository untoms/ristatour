                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                     <h3 class="box-title">Hapus Data Hotel</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form role="form" action="index.php?halaman=terimahapushotel" method='post'>
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="hotel" value="<?php echo $cetak['nama_hotel'];?>" readonly>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kursi" value="<?php echo $cetak['alamat'];?>" readonly>
                                        </div>
